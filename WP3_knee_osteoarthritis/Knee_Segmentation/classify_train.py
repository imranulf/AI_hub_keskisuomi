"""
classify_train.py — Train a ResNet-18 binary classifier (KL0 vs KL2)
...
def build_model(num_classes: int = 2, pretrained: bool = True) -> nn.Module:
    """
    Build a ResNet-18 classifier adapted for single-channel grayscale input.
    ...
    # Average the 3 RGB weight channels to initialize the single-channel weights
...
def main():
    parser = argparse.ArgumentParser(description="Train ResNet-18 for KL0 vs KL2 classification")
    ...
    out_dir = Path("classification_results") / args.name
